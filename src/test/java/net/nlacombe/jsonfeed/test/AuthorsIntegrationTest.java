...
public class AuthorsIntegrationTest {

    @Test
    public void test_json_feed_author_with_no_property() {
        assertThrows(JsonFeedException.class, () -> {
    ...
    @Test
    public void test_json_feed_legacy_author_from_v1() throws MalformedURLException {
    ...
    @Test
    public void test_json_feed_legacy_author_from_v1_and_authors_v1_1_prefer_authors() throws MalformedURLException {
